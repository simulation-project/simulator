...
public class BasicGraphEditor extends JPanel {
    ...
    public static void logMsg(String msg) {
        ...
        logedArea.append(simpleDateFormat.format(new Date())+ " : "+msg +"\n" );
    }
    /**
    ...
    public BasicGraphEditor(String appTitle, mxGraphComponent component) {
        ...
        logedArea = new JTextArea(20, 10);
        logedArea.setEditable(false);
        logedArea.setLineWrap(true);
        logedArea.setForeground(Color.BLUE);
        logedArea.setFont(new Font("TimesRoman",Font.BOLD + Font.ITALIC,14));
