 ...
 * @author sony
 */
public class Bno_analysis extends javax.swing.JFrame {
     ...
     */
    public Bno_analysis(String msc_name, String vlr) {
        initComponents();
        ...
        gt_trans = conn.get_Bno_analysis(msc_name);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        DatabaseHandler conn = new DatabaseHandler();
        conn.delete_Bno_analysis(msc_name);
        ...
        boolean check = conn.insert_Bno_analysis(gt_trans, msc_name, vlr);
