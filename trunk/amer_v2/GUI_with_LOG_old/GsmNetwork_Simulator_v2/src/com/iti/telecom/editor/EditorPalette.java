...
public class EditorPalette extends JPanel
{
			...
			int width, int height, Object value)
	{
		...
		cell.setVertex(true);
               ...
               // System.out.println("Out : " + cell.getStyle());
//                System.out.println("Msg : "+ cell.getSource().getId());
		addTemplate(name, icon, cell);
	}
	...
	public void addTemplate(final String name, ImageIcon icon, mxCell cell)
	{
		...
		entry.setFont(new Font(entry.getFont().getFamily(), 0, 13));
		...
		dragSource.createDefaultDragGestureRecognizer(entry,DnDConstants.ACTION_COPY,
                        dragGestureListener);
		add(entry);
	}
