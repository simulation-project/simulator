...
import com.iti.telecom.editor.EditorActions.ToggleOutlineItem;
...
public class SchemaEditorMenuBar extends JMenuBar
{
	...
	public SchemaEditorMenuBar(final BasicGraphEditor editor)
	{
		...
		menu.add(editor.bind(mxResources.get("redo"), new HistoryAction(false),
				"/com/iti/telecom/images/redo.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("cut"), TransferHandler
				.getCutAction(), "/com/iti/telecom/images/cut.gif"));
		menu.add(editor
		...
		menu.add(editor.bind(mxResources.get("delete"), mxGraphActions
				.getDeleteAction(),
				"/com/iti/telecom/images/delete.gif"));
				...
				.add(editor
						.bind(
								...
								new StylesheetAction(
										"/com/iti/telecom/resources/basic-style.xml")));
		submenu
				.add(editor
						.bind(
								mxResources.get("defaultStyle"),
								new StylesheetAction(
										"/com/iti/telecom/resources/default-style.xml")));
