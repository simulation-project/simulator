...
start(no, Name, SPC, Conf)->
    ...
    Msg1 = "HLR Starts with configuration :",
...
start(ok, Name,_SPC,_PID)->
    ...
    Msg = "this HLR Name : " ++ Name ++ " is already exists",
    request_handler:erlang_send(list_to_atom(Msg)).
...
update_location(L,SPC)->
    ...
    Msg = "HLR " ++ Name ++ " : Update Location Request ",
    request_handler:erlang_send(list_to_atom(Msg)),
